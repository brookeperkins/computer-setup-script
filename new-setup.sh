...
install-mongo-redhat() {
  ...
  sudo curl -o- https://raw.githubusercontent.com/alchemycodelab/computer-setup-script/script-rewrite/lib/mongodb-org-4.2.repo > /etc/yum.repos.d/mongodb-org-4.2.repo
